package in.automationtesting.practise.utilities;
		...
		try {
			URL url = new URL("file:///"+System.getProperty("user.dir")+"\\reports\\"+repName);
			 // Create the email message
			  ...
			  email.setAuthenticator(new DefaultAuthenticator("divya.bugathaa@gmail.com", "Sai0076!@"));
			  email.setSSLOnConnect(true);
			  email.setFrom("divya.bugathaa@gmail.com");   //Sender
			  email.setSubject("Test Results");
			  email.setMsg("Please find Attached Report....");
			  email.addTo("divya.bugathaa@gmail.com");   //Receiver
